...
# ── Shim tương thích ────────────────────────────────────────────────────────
# ragas (kể cả bản 0.3.9/0.4.x) import cứng `langchain_community.chat_models.vertexai`,
# nhưng module này đã bị gỡ khỏi các bản langchain-community mới (>=0.4) — xem
# https://github.com/vibrantlabsai/ragas/issues/2745. Lab này không dùng Google
# VertexAI, nên chèn 1 module giả để ragas import được mà không cần cài SDK VertexAI.
...
SYSTEM_V1 = (
    "Bạn là trợ lý AI thân thiện. Chỉ dùng context sau để trả lời câu hỏi. "
...
SYSTEM_V2 = (
    ...
    "đến câu hỏi, sau đó trả lời theo cấu trúc: "
    "1) Tóm tắt câu trả lời chính, 2) Giải thích chi tiết dựa trên context, "
    "3) Nêu rõ mức độ chắc chắn của câu trả lời (3-5 câu). "
